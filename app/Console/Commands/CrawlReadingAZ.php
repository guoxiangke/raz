    ...
    public function getPdf($pdfString){
        ...
        if(preg_match($pattern, $pdfString,$matchs)){
            ...
            if(Str::startsWith($pdfUri,'members')){
                $pdfUri = Str::replaceFirst("members",'pdfs', $pdfUri);
            }

            if(Str::startsWith($pdfUri,'site_and_dist')){
                $pdfUri = Str::replaceFirst("site_and_dist",'pdfsite', $pdfUri);
            }
...
//        }
        ...
        $bookIdStrings = "1532;282;924;174;173;929;1406;277;2893;1532;1020;273;1184;2333";
        ...
        foreach ($bookIds as $id){
            ...
            try {
                ...
                // 929
                // 1532
                //f=site_and_dist/lesson_plans/r/raz_lr33_alwaysrememberseptember11_lp.pdf
                $pdfString = $dom->find('#lesson-resources-content p.marginL a',1)->getAttribute('require-teacher-login');
